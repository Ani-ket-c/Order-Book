...
private:
    ...
    analytics::MicrostructureEngine* analytics_{nullptr};
    ...
    void updateAnalyticsOnTrade(bool aggressorBuy, int execPrice, int execQty);
    void updateAnalyticsFromBook();

    // Functions to balance AVL tree
    void updateLimitHeight(Limit* limit);
...
public:
    ...
    void setAnalyticsEngine(analytics::MicrostructureEngine* engine);
